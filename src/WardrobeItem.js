    ...
    render() {
        return (
            <div className="col-sm-4" style={{ "marginTop": "10px" }}>
                ...
                <Link to={"/app/wardrobe/ownedItem/" + this.props.item._id}><img src={this.props.item.imageURL} alt={this.props.item.title} style={{ "maxWidth": "200px", "maxHeight": "200px" }} /></Link>
